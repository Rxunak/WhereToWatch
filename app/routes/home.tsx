...
export default function Home() {
  ...
  return (
    <main className="bg-white dark:bg-neutral-900 border min-h-screen">
      <section className="flex flex-col gap-8 h-auto">
        <div className="flex flex-col items-center gap-2 pt-20">
          ...
          <h2 className="text-6xl text-center font-normal leading-18 dark:text-white">
        ...
        <div className="flex flex-col items-center gap-5 mb-8">
          ...
          <div className="flex items-center gap-2">
            <h1 className="dark:text-gray-500">Try</h1>
          ...
          <div className="flex justify-between border-t-2 w-250">
            {homepageFeatures.map((feature, index) => (
              <div key={index} className="w-80 flex flex-col gap-1 mt-4">
                <h1 className="font-bold text-sm dark:text-gray-400">
                  {feature.title}
                </h1>
